...
<table>
  ...
  <tbody>
    <tr><td><a href="skills/copywriting/">Copywriting</a></td><td>Experimental</td><td>Write evidence-led page, campaign, product, offer, and localization copy with explicit market, language, locale, channel, and claim-source controls, including native Simplified Chinese for China</td></tr>
