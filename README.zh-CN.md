...
<table>
  ...
  <tbody>
    ...
    <tr><td><a href="skills/evidence-led-copy/">证据驱动文案</a></td><td>在明确市场、语言、区域设置、渠道与声明来源的前提下，撰写页面、营销活动、产品、优惠与本地化文案，并支持面向中国大陆的原生简体中文表达</td></tr>
    <tr><td><a href="skills/copy-quality-review/">文案质量审校</a></td><td>在不改变事实含义的前提下，审校现有文案的清晰度、信息层级、语气、声明、无障碍、行动号召及市场、区域设置与渠道适配，并记录逐项精确修改</td></tr>
  </tbody>
</table>
