...
<table>
  ...
  <tbody>
    ...
    <tr><td><a href="skills/growth-postmortem/">增长事后复盘</a></td><td>构建、审查并更新以证据为边界的增长 Postmortem，保留原始决策，对齐计划与实际结果，区分结果质量与决策质量，约束因果主张，并将成功、失败、有害或无结论工作转化为可治理的学习与行动</td></tr>
