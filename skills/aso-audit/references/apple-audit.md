...
| Creative | APL-CRT-03 | Screenshot messages are legible at browse size | 3 | Dated screenshot capture |
| Creative | APL-CRT-04 | Screenshot messages are unobscured at browse size | 1 | Dated screenshot capture |
| Creative | APL-CRT-05 | Screenshot visuals are specific to the stated product use case | 1 | Dated screenshot capture |
| Creative | APL-CRT-06 | [Optional] App preview communicates the primary use case when present | 4 | Product-page capture |
