...
Treat every market as a new customer hierarchy, product, value, identity, telemetry, CRM, support, contract, payment, invoice, renewal, label, model, threshold, service, source, privacy, and ownership boundary. For mainland China, distinguish market, legal entity, language, locale, currency, timezone, product, platform, identity, payment, invoice, data, consent, privacy, sources, and locally accountable review. Translation and currency conversion do not validate transfer. Avoid legal, tax, regulatory, provider, accounting, approval, causal, or performance conclusions.
